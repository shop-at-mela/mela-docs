...
| [gifting-festival-traffic-prd.md](prds/gifting-festival-traffic-prd.md) | 🔲 Ready | P0 | Day 2 filtering depends on Day 1 schema; extends enrichment + occasion-module + search-ranking PRDs | Day-split: D1 pipeline (occasion broaden + `gift_occasion` + `recipient` + glossing) — run in parallel; D2 web gifting landing/filters/sort + attribution; D3 social calendar/boards + brand sourcing + ads-readiness gate |
