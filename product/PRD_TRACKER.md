...
| [crossshop-tracking-prd.md](prds/crossshop-tracking-prd.md) | 🔲 Ready | P0 | Needs GTM/GA4/Clarity accounts created | GTM+GA4+Clarity install, entry-source capture, `brand_clickout` event across 3 CTA surfaces |
